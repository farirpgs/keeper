...
links:
  ...
  Drivethru RPG: https://www.drivethrurpg.com/product/219203/Fate-Adversary-Toolkit
---
...
- <strong>Resistances</strong> make other adversaries hard to handle in a
  ...
  immune to mortal weaponry, we must go on a quest to find the one sword that
  <em>will</em> hurt it.
